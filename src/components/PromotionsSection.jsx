            ...
            <div className="relative z-10 p-8 md:p-12 lg:p-20">
              <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-center">
                ...
                <div className="md:col-span-2 flex flex-col items-center md:items-end justify-center">
                  <button className="group/btn relative text-white px-8 py-5 rounded-2xl font-bold text-lg hover:scale-105 transform transition-all duration-300 shadow-2xl hover:shadow-3xl border border-white/20 w-full md:w-auto" style={{background: 'linear-gradient(135deg, #6699CC, #5588BB, #4477AA)'}}>
